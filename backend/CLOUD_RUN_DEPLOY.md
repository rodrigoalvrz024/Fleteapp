...
gcloud run deploy $env:SERVICE `
  ...
  --set-env-vars ALGORITHM=HS256,ACCESS_TOKEN_EXPIRE_MINUTES=1440,TRANSBANK_ENVIRONMENT=integration,RUN_STARTUP_MIGRATIONS=false,ENABLE_DRIVER_PUSH_NOTIFICATIONS=false,DB_POOL_SIZE=8,DB_MAX_OVERFLOW=2,DB_POOL_TIMEOUT_SECONDS=5,DB_CONNECT_TIMEOUT_SECONDS=10
```
