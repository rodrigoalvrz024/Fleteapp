...
class _DriverHomeScreenState extends ConsumerState<DriverHomeScreen> {
  ...
  void _rotateStatus() async {
    while (mounted) {
      ...
      if (!mounted) return;
      setState(() => _statusIndex = (_statusIndex + 1) % _statusMsgs.length);
    }
  }
...
class _IncomingFreightDialog extends StatefulWidget {
  ...
  @override
  State<_IncomingFreightDialog> createState() => _IncomingFreightDialogState();
}

class _IncomingFreightDialogState extends State<_IncomingFreightDialog> {
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    ...
                    color: pct > 0.4 ? AppTheme.success : AppTheme.urgent,
                  ),
                ),
                Text('$_remaining',
                    style: const TextStyle(
            ...
            _RouteRow(
              ...
              destination: widget.freight.destinationAddress,
            ),
            const SizedBox(height: 14),
            ...
            Row(
              ...
              children: [
                ...
                _InfoChip(
                  ...
                  label: '${widget.freight.cargoWeightKg} kg',
                  color: AppTheme.slate600,
                ),
              ],
            ),
          ...
          children: [
            ...
            Row(children: [
              ...
              if (_nextStatus.isNotEmpty) ...[
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () => onUpdateStatus(_nextStatus),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: AppTheme.success,
                      minimumSize: const Size(double.infinity, 42),
                      shape: RoundedRectangleBorder(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(children: [
              Container(width: 1, height: 8, color: AppTheme.slate200),
            ]),
          ),
          Row(children: [
            ...
            _SupportOpt(
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content:
                        const Text('Reporte enviado. Te contactaremos pronto.'),
                    backgroundColor: AppTheme.success,
                    behavior: SnackBarBehavior.floating,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12)),
