...
SYMBOL_GROUPS = {
    ...
    "monetary_format": {"strfmon", "strfmon_l", "__strfmon", "__strfmon_l", "__vstrfmon_l"},
...
LIMITATIONS = [
    ...
    "Monetary formatting symbols identify possible strfmon callers, not their formats, widths or buffer sizes.",
