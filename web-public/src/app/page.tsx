    ...
    <main>
      <section className="homeHero" id="inicio">
        ...
        <div className="homeHeroInner">
          ...
          <p className="heroLead">
            FleteApp conecta clientes con conductores verificados para mover
      ...
      <section className="section trustSection">
        <div className="sectionHeader compact">
          ...
          <p>
            FleteApp esta pensada para registrar lo que pasa en cada traslado y
      ...
      <section className="ctaBand">
        <div>
          ...
          <h2>Usa la web para conocer FleteApp. Usa la app para operar.</h2>
          <p>
